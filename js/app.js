...
function setup(){
  ...
  function direction(keyCode1, keyCode2, object){
    if(keypress[keyCode1] && keyCode1===65){
      ...
      $player1.css({
        borderRadius: '15px 2px 0 0'
      });
      $player1Visor.css({
        left: '0px',
        borderRadius: '10px 2px 0 0'
      });
      $player1Gun.css({
        left: '-9px'
      });
  ...
  function newPositionX(oldPosition, keyCode1, keyCode2, object) {
    ...
    var newPositionX = parseFloat(oldPosition, 10) - (keypress[keyCode1] ? direction(keyCode1, keyCode2, object) : 0) + (keypress[keyCode2] ? direction(keyCode1, keyCode2, object) : 0);
